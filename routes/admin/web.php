...
Route::middleware([
    ...
    ->group(function () {
        ...
        Route::name('admin.')->prefix('admin')->group(function () {
            ...
            //home
            Route::get('/top-statistics', 'HomeController@topStatistics')->name('home.top-statistics');
            Route::get('/movies-chart', 'HomeController@moviesChart')->name('home.movies-chart');
